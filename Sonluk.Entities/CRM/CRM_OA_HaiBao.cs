...
namespace Sonluk.Entities.CRM
{
    public class CRM_OA_HaiBao
    {
        ...
        List<CRM_OA_HaiBao_DP> _HaiBao_DP;

        public List<CRM_OA_HaiBao_DP> HaiBao_DP
        {
            get { return _HaiBao_DP; }
            set { _HaiBao_DP = value; }
        }


        public class CRM_OA_HaiBao_DP
        {
            string _CPMC;
            ...
            {
                get { return _ISCXZCOUNT; }
                set { _ISCXZCOUNT = value; }
            }
